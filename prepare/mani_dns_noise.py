...
parser = argparse.ArgumentParser(description='Generate manifest for audio dataset, DNS-challenge-5 noise data',
                                     add_help=True,
...
# noise
audio_dir = data_dir / 'datasets_fullband/noise_fullband'
audio_manifest = out_dir / f'sfx_dns5.csv'
audio_len = 0
